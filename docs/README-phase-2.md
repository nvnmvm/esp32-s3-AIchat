...
`v2.1.3-phase2-stable` 支持从 `v2.0.1-phase2`、`v2.0.2-phase2` 和 `v2.1.x` 保留 `.env` 与 `runtime/` 更新。其他旧版本或未知版本会在更新菜单中提示先备份，或选择不保留运行数据更新。
...
- 云端 tag/release：`v2.1.3-phase2-stable`
- 配套固件 tag/release：`v2.1.2-display-stable`
